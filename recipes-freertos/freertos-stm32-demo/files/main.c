...
StackType_t usbTaskStack[LED_Task_STACK_SIZE] CCM_RAM;  // Put task stack in CCM
...
int main(void)
{
  ...
  xTaskCreateStatic(LED_Task, "USB", LED_Task_STACK_SIZE, NULL, 1, usbTaskStack, &usbTaskBuffer);
