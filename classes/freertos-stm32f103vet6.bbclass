...
EXTRA_OEMAKE_append = " STM32_USB_DEVICE_LIB_OBJS=usbd_core.o"
EXTRA_OEMAKE_append = " STM32_USB_DEVICE_LIB_OBJS+=usbd_ctlreq.o"
EXTRA_OEMAKE_append = " STM32_USB_DEVICE_LIB_OBJS+=usbd_ioreq.o"
EXTRA_OEMAKE_append = " STM32_USB_DEVICE_LIB_OBJS+=usbd_cdc.o"
...
CFLAGS_append = " -I$(STM32CUBEF1)/Middlewares/ST/STM32_USB_Device_Library/Core/Inc"
CFLAGS_append = " -I$(STM32CUBEF1)/Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Inc"
